...
from alpha_lab.ingestion import IngestionService, UniverseIngestionService  # noqa: E402
...
def main() -> None:
    ...
    try:
        ...
        tickers = UniverseIngestionService(
            NasdaqTraderUniverseProvider(), engine
        ).research_tickers(limit=args.limit)
